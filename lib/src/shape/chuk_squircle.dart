...
/// Clips a child to a squircle shape.
  ...
  Widget build(BuildContext context) {
    return ClipPath(
      clipper: ShapeBorderClipper(
        shape: SquircleBorder(radius: radius, smoothing: smoothing),
      ),
...
/// Clips to the exact iOS app-icon shape (radius relative to width).
class ClipAppIcon extends StatelessWidget {
  const ClipAppIcon({super.key, required this.child, required this.size});
  ...
  Widget build(BuildContext context) {
    return SizedBox.square(
      dimension: size,
      child: ClipSquircle(
        radius: size * kAppleIconRadiusRatio,
